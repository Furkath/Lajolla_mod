...
struct eval_op {
    ...
    Spectrum operator()(const DisneyTintMetal &bsdf) const;
    ...
    Spectrum operator()(const NprTintMetal &bsdf) const;
...
struct pdf_sample_bsdf_op {
    ...
    Real operator()(const DisneyTintMetal &bsdf) const;
    ...
    Real operator()(const NprTintMetal &bsdf) const;
...
struct sample_bsdf_op {
    ...
    std::optional<BSDFSampleRecord> operator()(const DisneyTintMetal &bsdf) const;
    ...
    std::optional<BSDFSampleRecord> operator()(const NprTintMetal &bsdf) const;
...
struct get_texture_op {
    ...
    TextureSpectrum operator()(const DisneyTintMetal &bsdf) const;
    ...
    TextureSpectrum operator()(const NprTintMetal &bsdf) const;
...
#include "materials/disney_tintmetal.inl"
...
#include "materials/npr_tintmetal.inl"
